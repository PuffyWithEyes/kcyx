...
export default defineComponent({
  ...
  data() {
    return {
      posts: [
        {
          itemsList: [
            { type: 'image', src: '/test/image.png', alt: 'Image 1' },
            { type: 'text', content: 'This is some text between images.' },
            { type: 'image', src: '/test/image copy.png', alt: 'Image 2' },
          ] as Item[],
          userAvatar: '/test/image.png',
          userName: 'puffy_with_eyes',
          viewCount: 1,
        },
        {
          itemsList: [
            { type: 'image', src: '/test/image.png', alt: 'Image 3' },
            { type: 'image', src: '/test/image.png', alt: 'Image 4' },
  ...
  methods: {
    addPost(newPost: Item) {
      this.posts.unshift({
        itemsList: [newPost],
        userAvatar: '/test/image.png', // Замените на аватарку пользователя
